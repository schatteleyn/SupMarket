 ...
 * @author schatteleyn
 */
@WebService(serviceName = "SalesExportService", portName = "SalesExportPort", endpointInterface = "com.supsellers.us.sales.export.SalesExport", targetNamespace = "http://us.supsellers.com/sales/export", wsdlLocation = "WEB-INF/wsdl/SoapApi/supseller-paris.servme.fr/app/SalesExportService.wsdl")
@Stateless
