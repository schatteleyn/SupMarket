...
public class SaleService {
    ...
    public String getTotalSales(String country, String gender, String status, String income) {
    ...
    public String getTotalAmountSold(String country, String gender, String status, String income) {
    ...
    public String dashboardData() {
        String totalSales = getTotalSales(null, null, null, null);
        String totalAmountSold = getTotalAmountSold(null, null, null, null);
        HashMap bestSellingProduct = new HashMap();
        HashMap worstSellingProduct = new HashMap();
        HashMap salesByChannel = new HashMap();
        HashMap salesByCountries = new HashMap();
        HashMap salesByGender = new HashMap();
        HashMap salesByStatus = new HashMap();
        HashMap salesByIncome = new HashMap();
        HashMap mostLoyal = new HashMap();
        
        for(Sales s : getBestSellingProduct(null, null, null, null)) {
         //   bestSellingProduct.put();
        }
        for(Sales s : getWorstSellingProduct(null, null, null, null)) {
           // worstSellingProduct += s.toString();
        }
        for(Sales s : salesByChannels(null, null, null, null)) {
            salesByChannel.put("Name", s.getChannelId().getChannelDesc());
            salesByChannel.put("Number", s);
        }
        for(Sales s : salesByCountries(null, null, null, null)) {
           // salesByCountries += s.toString();
        }
        for(Sales s : salesByGenders(null, null, null, null)) {
          //  salesByGender += s.toString();
        }
        for(Sales s : salesByMaritalStatus(null, null, null, null)) {
         //   salesByStatus += s.toString();
        }
        for(Sales s : salesByIncome(null, null, null, null)) {
         //   salesByIncome += s.toString();
        }
        for(Sales s : mostLoyal(null, null, null, null)) {
         //   mostLoyal += s.toString();
        }
        
        StringBuilder writer = new StringBuilder();
        writer.append("{");
            writer.append("\"totalSales\":").append(totalSales).append(",");
            writer.append("\"totalAmountSold\":").append(totalAmountSold).append(",");
            writer.append("\"bestSellingProduct\":").append(bestSellingProduct).append(",");
            writer.append("\"worstSellingProduct\":").append(worstSellingProduct).append(",");
            writer.append("\"salesByChannel\":").append(salesByChannel).append(",");
            writer.append("\"salesByCountries\":").append(salesByCountries).append(",");
            writer.append("\"salesByGenders\":").append(salesByGender).append(",");
            writer.append("\"salesByMaritalStatus\":").append(salesByStatus).append(",");
            writer.append("\"salesByIncome\":").append(salesByIncome).append(",");
            writer.append("\"mostLoyal\":").append(mostLoyal);
        writer.append("}");
        ...
        for (Sales sales : canadaSales) {
            writer.append("{");
                ...
                writer.append("},\"promotion\":{");
                    ...
                    writer.append("\"promoTotal\":").append("\"").append(sales.getPromoId().getPromoTotal()).append("\"").append(",");
